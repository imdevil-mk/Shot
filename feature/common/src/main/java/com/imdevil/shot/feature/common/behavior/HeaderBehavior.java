 ...
 * com.imdevil.shot.feature.common.behavior.HeaderScrollingViewBehavior}.
 */
public abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    int setHeaderTopBottomOffset(
        ...
        /*/
        Dog.INSTANCE.d(TAG, "setHeaderTopBottomOffset: "
                + " curOffset = " + String.format(Locale.getDefault(), "%-4d", curOffset)
                + " minOffset = " + String.format(Locale.getDefault(), "%-4d", minOffset)
                + " maxOffset = " + String.format(Locale.getDefault(), "%-4d", maxOffset)
                + " newOffset = " + String.format(Locale.getDefault(), "%-4d", newOffset)
                + " consumed = " + String.format(Locale.getDefault(), "%-4d", consumed)
        );
        //*/
        return consumed;
    }
